...
export const helpContent4 = (
  <div className="flex flex-col gap-4 text-sm">
    <p>
      <span className="font-bold">1. 교과목명과 교과목 코드를 설정합니다.</span>
    ...
    <p>
      ...
      <p className="indent-2">
        • 같은 학년의 교과목끼리는 중복되는 시간이 없도록 자동적으로 배치합니다.
      </p>
    </p>
    <p>
    ...
    <p>
      <span className="font-bold">6. 각 교과목에 대해 분반을 설정합니다.</span>
      <p className="indent-2">• 분반 번호는 자동으로 시스템에서 관리합니다.</p>
      <p className="indent-2">
        • 강의 시간 분리 1/2는 한 번 강의할 때의 강의 시간을 나타냅니다.
      </p>
      <p className="indent-2">
        • 강의 시간 분리 그룹화 체크를 하면, 다른 분반을 같은 시간에 배정합니다.
        (캡스톤디자인)
      </p>
